  ...
  return (
    <>
      ...
      <div style={{ marginTop: 18, color: "#333", lineHeight: 1.9, fontSize: 15 }}>
        <p>QUALog（以下「本サービス」）は、利用者の個人情報を以下の方針に基づき取り扱います。</p>
        ...
        <Section title="3. AI機能の利用について">
          <p>本サービスでは、学習支援の目的で外部AIサービスを利用する場合があります。</p>
          <p style={{ marginTop: 8 }}>
        ...
        <Section title="7. アクセス解析・ログ">
          <p>本サービスでは、安定運用および改善のため、アクセスログやエラーログを取得する場合があります。</p>
        ...
        <Section title="10. 広告配信について">
          ...
          <p style={{ marginTop: 8 }}>ユーザーは、広告設定によりパーソナライズ広告を無効にすることができます。</p>
          <p style={{ marginTop: 8 }}>本サービスでは、Google Analytics 等のアクセス解析ツールを利用する場合があります。</p>
          <p style={{ marginTop: 8 }}>
        ...
        <div style={{ marginTop: 28, fontSize: 12, color: "#666" }}>最終更新日：2026-01-17</div>
      </div>
    </>
  );
}

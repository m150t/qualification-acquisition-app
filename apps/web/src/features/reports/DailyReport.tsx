        ...
        <Card className="space-y-5 p-4">
          <div className="space-y-3">
            <div className="flex items-center justify-between gap-3">
              <p className="text-base font-semibold text-gray-900">日報入力</p>
              <p className="text-sm text-blue-600">タスク {selectedPlan?.tasks?.length ?? 0}件</p>
            </div>
          ...
          {selectedReport?.content ? (
            <div className="rounded-md bg-amber-50 p-3">
              <p className="text-xs text-amber-700">この日に保存済みのメモ</p>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="学習でできたこと・詰まったことなどを入力"
            />
          </div>

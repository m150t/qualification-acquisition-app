      ...
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <div style={{ marginTop: 18, color: "#333", lineHeight: 1.9, fontSize: 15 }}>
          ...
          <Section title="3. AI機能の利用について">
            <li>本サービスでは、学習支援の目的で外部AIサービスを利用する場合があります。</li>
            <li>その際、AI処理に必要な範囲で利用者が入力した情報を送信することがありますが、個人を特定する目的では使用しません。</li>
          </Section>
          ...
          <Section title="6. 退会およびデータ削除">
            <li>利用者は、本サービス内の退会機能を利用することで、アカウントおよび関連する利用者データを削除できます。</li>
            <li>退会後、当該データは合理的な期間内に削除されます。</li>
          </Section>

          <Section title="7. アクセス解析・ログ">
            <li>本サービスでは、安定運用および改善のため、アクセスログやエラーログを取得する場合があります。これらの情報は個人を特定する目的では利用しません。</li>
          </Section>
          ...
          <Section title="10. 広告配信について">
            <li>本サービスでは、第三者配信の広告サービス（Google AdSense等）を利用する場合があります。</li>
            <li>広告配信事業者は、ユーザーの興味に応じた広告を表示するために Cookie を使用することがあります。</li>
            <li>Google を含む第三者配信事業者は、Cookie を使用して、ユーザーが本サービスや他のウェブサイトに過去にアクセスした情報に基づいて広告を配信します。</li>
            <li>ユーザーは、広告設定によりパーソナライズ広告を無効にすることができます。</li>
            <li>本サービスでは、Google Analytics 等のアクセス解析ツールを利用する場合があります。</li>
            <li>これらのツールはトラフィックデータ収集のために Cookie を使用しますが、このデータは匿名で収集され、個人を特定するものではありません。</li>
          </Section>

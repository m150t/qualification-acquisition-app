...
const certifications = [
  ...
  { id: 3, name: 'TOEIC 800点', progress: 80, examDate: '2025年3月15日', status: '学習中' },
];
...
const recentAchievements = [
  { id: 1, title: '連続7日間学習達成', date: '2025年11月7日' },
  { id: 2, title: '応用情報 模擬試験60点突破', date: '2025年11月5日' },
  { id: 3, title: '今月学習時間50時間達成', date: '2025年11月1日' },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">進行中の資格</p>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-gray-700">応用情報 アルゴリズム問題 10問</span>
              </label>
              <label className="flex items-start gap-3 cursor-pointer">
                <input type="checkbox" className="mt-1 w-4 h-4 text-blue-600 rounded" />
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                <input type="checkbox" className="mt-1 w-4 h-4 text-blue-600 rounded" />
                <span className="text-gray-700">TOEIC リスニング練習 30分</span>
              </label>
            </div>
          </Card>
        </div>

...
const previousReports = [
  {
    ...
    aiComment: '良いペースです！ポリシーは最初は難しいですが、実践で慣れていきましょう。明日は実際のサンプルポリシーを見て理解を深めると良いでしょう。',
    studyTime: '1.5時間',
    tasksCompleted: 3,
  },
  {
...
export function DailyReport({ onBack }: DailyReportProps) {
  ...
  const handleSubmit = () => {
    ...
    setAiResponse(
      '素晴らしい進捗です！IAMポリシーの理解が深まっていますね。実践的な演習問題で知識を定着させましょう。明日はセキュリティベストプラクティスについて学ぶと、さらに理解が深まります。この調子で頑張りましょう！'
    );
    setSubmitted(true);
  };
            ...
            <Card className="p-4">
              <div className="flex items-center gap-2 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">2025年11月8日</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="例：IAMポリシーの演習問題を10問解いた。ロールとユーザーの使い分けについて理解が深まった。"
                    rows={5}
                    className="w-full"
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    学んだこと、難しかったこと、気づいたことなど自由に書いてください
                  </p>
                </div>
